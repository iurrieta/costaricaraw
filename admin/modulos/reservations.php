...
<table width="95%" align="center" border="0" cellspacing="0" cellpadding="2" style="border-left:#000 solid 1px; border-top:#000 solid 1px; border-right:#000 solid 1px;">
      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="2" align="center" style="border-left:#000 solid 1px; border-top:#000 solid 1px; border-right:#000 solid 1px;">
		 ...
		 if($Lineas['code']){ ?>
          <tr>
            <td bgcolor="#FFFFFF" align="right" style="border-bottom:#000000 1px solid; border-right:#000 1px solid;"><strong>Confirmation Code:</strong></td>
            <td colspan="11" bgcolor="#FFFFFF" style="border-bottom:#000000 1px solid; "><strong><?=$Lineas['code']?></strong></td>
          </tr>
...
$emailAfiliado = $Referal['email'];
$bodyHTML .= '<br>'.$Adicional2;
...
$Item = "<br><b>Item:</b> ".$Lineas['item'];
	 ...
	 $emailAventuras .= "<b>Adventure: </b>".$Aventure."<br><b>Location: ".$LocationName."</b><br><b>Date:</b> ".$Lineas['fecha']."".$Item."<br><b>Departure:</b> ".$Lineas['departure']."<br><b>Return:</b> ".$Lineas['end']."<br><b>Qty:</b> ".$Lineas['people']."<br>".$BalanceDue.".<br><strong>Note: Balance for each item is due upon arrival.</strong>".$PickupText.$SpecialNote.$CodeText."<hr>";
  ...
  <tr>
    <td align="center" colspan="3"><h2>Enjoying the Paths-Preserving the future</h2></td>
	 ...
	 <tr>
    <td colspan="3">"This person must be present with ID/Passport at time of check-in/departure!"<br>
	<strong>Note: Balance for each item is due upon arrival.</strong><br><br>
...
if(($Invoice['status']=="2")||($Invoice['status']=="5")){
	...
	@mail($emailAfiliado,"New Reservation #".$Invoice['id'],$mensaje_formato_two,$headers);
}
