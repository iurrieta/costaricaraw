...
?>
          ...
          <div class="addthis_toolbox addthis_default_style" align="right"> <a class="addthis_button_preferred_1"></a> <a class="addthis_button_preferred_2"></a> <a class="addthis_button_preferred_3"></a> <a class="addthis_button_preferred_4"></a> <a class="addthis_button_compact"></a> <a class="addthis_counter addthis_bubble_style"></a> </div>
...
<tr>
  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><h3>xxx <?php echo $TopFeatured; ?></h3>
          <?php if($_SESSION['affiliateID']>0 and $TopAfiliado['show_note']==1){  ?>
          <b><?php echo "NOTE: " . $TopAfiliado['note']; ?></b>
          <?php } ?></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><?php if($TopAfiliado['1'] > 0){ ?>
		...
		$TextoResumen = substr($TextoPlano,0,strrpos(substr($TextoPlano,0,$MaxLENGTH)," "));
		   ...
		   ?>
            <tr>
              ...
              <td width="300" colspan="2" valign="bottom" class="top10"><a href="?cmd=adventures&adv=<?=$TopAdventure['id']?>">
                <?=$TopAdventure['name']?>
                </a>&nbsp;&nbsp;(
                <?=$LocationAdventureTop['name']?>
                )</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td colspan="4" valign="top"><span style="font-size:11px;text-align:justify;">
                <?php 
...
if($_SESSION['topAdventure']==0 and $TopAfiliado['raw']==0){
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="32">&nbsp;</td>
          <td width="32" height="32" align="left" valign="middle"><img src="images/adventure.gif" align="absmiddle" border="0" height="20" /></td>
          <td width="300" valign="bottom" class="top10"><a href="?cmd=adventures&adv=<?=$TopRated['id']?>"><?=$TopRated['name']?></a>&nbsp;&nbsp;(<?=$LocationAdventure['name']?>)</td>
          <td height="35" valign="bottom"><a href="book.php?adventure=<?=$TopRated['id']?>" rel="facebox"><img src="images/book-now.png" border="0" /></a></td>
        </tr>
        <tr>
	...
	if($_SESSION['affiliateID']==0 and $_SESSION['topAdventure']==0 ){
	?>
      <tr>
	...
	while($Categoria=$db->fetch_array($sqlCat)){
		...
		$TextoResumen = substr($TextoPlano,0,strrpos(substr($TextoPlano,0,$MaxLENGTH)," "));
          ...
          <?php  if($_SESSION['affiliateID']>0 and $TopAfiliado1['special']==1 ){  ?>
      <tr>
        <td><h3><?php echo $TopSpecial; ?></h3>
		...
		$TextoResumen = substr($TextoPlano,0,strrpos(substr($TextoPlano,0,$MaxLENGTH)," "));
		   ...
		   ?>
            <tr>
              <td width="32">&nbsp;</td>
              <td width="32" height="32" valign="bottom"><img src="images/adventure.gif" align="absmiddle" border="0" height="20" /></td>
              <td width="300" colspan="2" valign="bottom" class="top10"><a href="?cmd=adventures&adv=<?=$TopAdventure1['id']?>">
                <?=$TopAdventure1['name']?>
                </a>&nbsp;&nbsp;(
                <?=$LocationAdventureTop['name']?>
                )</td>
              <td height="35" valign="bottom"><a href="book.php?adventure=<?=$TopAdventure1['id']?>" rel="facebox"><img src="images/book-now.png" border="0" /></a></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td colspan="4" valign="top"><span style="font-size:11px;text-align:justify;">
...
if($_SESSION['topAdventure']==1 and $TopAfiliado['raw']==1){
//if($_SESSION['topAdventure']==0 and raw){
		...
		$TextoResumen = substr($TextoPlano,0,strrpos(substr($TextoPlano,0,$MaxLENGTH)," "));
		   ?>
                  <tr>
                    <td width="32">&nbsp;</td>
                    <td width="32" height="32" valign="bottom"><img src="images/adventure.gif" align="absmiddle" border="0" height="20" /></td>
                    <td width="300" valign="bottom" class="top10"><a href="?cmd=adventures&adv=<?=$TopRated['id']?>">
                      <?=$TopRated['name']?>
                      </a>&nbsp;&nbsp;(
                      <?=$LocationAdventure['name']?>
                      )</td>
                    <td height="35" valign="bottom"><a href="book.php?adventure=<?=$TopRated['id']?>" rel="facebox"><img src="images/book-now.png" border="0" /></a></td>
                  </tr>
                  <tr>
