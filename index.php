              ...
              <td width="86%" height="50" align="right" valign="bottom" style="background:url(images/bgTop.png) no-repeat bottom left;"><form name="language" id="language" method="post">
                ...
                <table border="0" cellspacing="2" cellpadding="2" style="margin-right:45px;">
                  <tr>
                      <!--carrito de compra-->
                      <td align="center">
                          <a href="https://www.costaricaraw.com/dev/index.php?cmd=cart" title="View Shopping Cart"><strong>Shopping Cart</strong>
                              <img src="images/cart.png" alt="View Shopping Cart" width="24" height="24" border="0" align="absmiddle" title="View Shopping Cart" />
                              <?php
                              if($carro){
                                  $contador=0;
                                  $suma=0;
...
<?php include('modulos/modulos.php'); ?>
​
<!-- InstanceEndEditable --></td>
                              </tr>
                            </table>
