...
if($installed==true){
 ...
 $server = 'localhost';
 $database = 'crrakama_livechat';
 $datausername = 'crrakama_admchat';
 $password = 'zzf3wB7OHa';
 ...
 $application_root = '/home/crrakama/public_html/livechat/';
 ...
 $API_HOME_DIR = '/home/crrakama/public_html/livechat/' . 'txt-db-api/';
