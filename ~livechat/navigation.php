...
<DIV STYLE="border: 1px #08245B dotted;width:192px;">
 ...
 <tr><td class="leftnavlink"><a href="http://www.craftysyntax.com/howto.php?v=<?php echo $CSLH_Config['version']; ?>&d=<?php echo $CSLH_Config['directoryid'] ?>&h=<?php echo $_SERVER['HTTP_HOST']; ?>" onmouseout="document.arrows1.src=r_arrow.src"  onmouseover="document.arrows1.src=h_arrow.src" target=_blank><img src=images/arrow_off.gif width="20" height="12" border="0" name="arrows1"><?php echo $lang['documentation']; ?></a></td></tr>
...
<?php } ?>
 ...
 <tr><td class="leftnavlink"><a href="http://www.craftysyntax.com/support.php?v=<?php echo $CSLH_Config['version']; ?>&d=<?php echo $CSLH_Config['directoryid'] ?>&h=<?php echo $_SERVER['HTTP_HOST']; ?>" target=_blank onmouseout="document.arrows4qwe.src=r_arrow.src"  onmouseover="document.arrows4qwe.src=h_arrow.src" target=_top><img src=images/arrow_off.gif width="20" height="12" border="0" name="arrows4qwe">priority Support</a></td></tr> 
 ...
 <tr><td class="leftnavlink"><a href="http://www.craftysyntax.com/members/?v=<?php echo $CSLH_Config['version']; ?>&d=<?php echo $CSLH_Config['directoryid'] ?>&h=<?php echo $_SERVER['HTTP_HOST']; ?>" target="_blank" onmouseout="document.arrows5a.src=r_arrow.src"  onmouseover="document.arrows5a.src=h_arrow.src" target="contents"><img src=images/arrow_off.gif width="20" height="12" border="0" name="arrows5a">CSLH Registration</a></td></tr> 	 
 <tr><td class="leftnavlink"><a href="http://www.craftysyntax.com/account.php?v=<?php echo $CSLH_Config['version']; ?>&d=<?php echo $CSLH_Config['directoryid'] ?>&h=<?php echo $_SERVER['HTTP_HOST']; ?>" target="_blank" onmouseout="document.arrows5ax.src=r_arrow.src"  onmouseover="document.arrows5ax.src=h_arrow.src" target="_blank"><img src=images/arrow_off.gif width="20" height="12" border="0" name="arrows5ax">Member Services</a></td></tr> 	  
 <tr><td class="leftnavlink"><a href="http://www.craftysyntax.com/qa.php?v=<?php echo $CSLH_Config['version']; ?>&d=<?php echo $CSLH_Config['directoryid'] ?>&h=<?php echo $_SERVER['HTTP_HOST']; ?>" onmouseout="document.arrows27av.src=r_arrow.src"  onmouseover="document.arrows27av.src=h_arrow.src" target="_blank"><img src=images/arrow_off.gif width="20" height="12" border="0" name="arrows27av">Questions and Answers</a></td></tr>  
 <tr><td class="leftnavlink"><a href="http://www.craftysyntax.com/features.php?v=<?php echo $CSLH_Config['version']; ?>&d=<?php echo $CSLH_Config['directoryid'] ?>&h=<?php echo $_SERVER['HTTP_HOST']; ?>" onmouseout="document.arrows27a.src=r_arrow.src"  onmouseover="document.arrows27a.src=h_arrow.src" target="_blank"><img src=images/arrow_off.gif width="20" height="12" border="0" name="arrows27a">Feature Requests !!</a></td></tr>
...
<DIV STYLE="border: 1px #08245B dotted;width:192px;">
 ...
 <tr><td class="leftnavlink"><a href="https://addons.mozilla.org/en-US/firefox/addon/12381" onmouseout="document.arrows12d.src=r_arrow.src"  onmouseover="document.arrows12d.src=h_arrow.src" target="_blank"><img src=images/arrow_off.gif width="20" height="12" border="0" name="arrows12d">FF Add-on Application</a></td></tr>
 <tr><td class="leftnavlink"><a href="http://craftysyntax.com/mobile.php" onmouseout="document.arrows12as.src=r_arrow.src"  onmouseover="document.arrows12as.src=h_arrow.src" target="_blank"><img src=images/arrow_off.gif width="20" height="12" border="0" name="arrows12as">Mobile Version</a></td></tr>
 <tr><td class="leftnavlink"><a href="http://craftysyntax.com/iphone.php" onmouseout="document.arrows12das.src=r_arrow.src"  onmouseover="document.arrows12das.src=h_arrow.src" target="_blank"><img src=images/arrow_off.gif width="20" height="12" border="0" name="arrows12das">iphone app</a></td></tr>
 <tr><td class="leftnavlink"><a href="http://www.craftysyntax.com/unbranded.php?d=<?php echo $CSLH_Config['directoryid'] ?>" target="_blank" onmouseout="document.arrows5ab.src=r_arrow.src"  onmouseover="document.arrows5ab.src=h_arrow.src" target="contents"><img src=images/arrow_off.gif width="20" height="12" border="0" name="arrows5ab">Unbranded Option !</a></td></tr> 	
 <tr><td class="leftnavlink"><a href="http://www.craftysyntax.com/hosted.php?d=<?php echo $CSLH_Config['directoryid'] ?>" target="_blank" onmouseout="document.arrows5ac.src=r_arrow.src"  onmouseover="document.arrows5ac.src=h_arrow.src" target="contents"><img src=images/arrow_off.gif width="20" height="12" border="0" name="arrows5ac">HOSTED Option </a></td></tr> 	
...
<DIV STYLE="border: 1px #08245B dotted;width:192px;">
 ...
 <?php } ?>
  <tr><td class="leftnavlink"><a href="http://www.craftysyntax.com/integration.php?d=<?php echo $CSLH_Config['directoryid'] ?>" onmouseout="document.arrows16a.src=r_arrow.src"  onmouseover="document.arrows16a.src=h_arrow.src" target="_top"><img src=images/arrow_off.gif width="20" height="12" border="0" name="arrows16a"> integration options</a></td></tr> 
...
<a class="adminnavleft" href=http://www.craftysyntax.com/ target=_blank>Crafty Syntax Live Help</a><br> &copy; 2003 - 2012  <a class="adminnavleft" href=http://www.craftysyntax.com/EricGerdes/ target=_blank>Eric Gerdes</a>  
<br>
